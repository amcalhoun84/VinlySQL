...
("Carmenere",
"Also known as Grande Vidure, once widely planted in Bordeaux. Now primarily associated with Chile. Carmenere, was imported to Chile in the 1850’s. Carmenere has been frequently mislabeled and many growers and the Chilean government consider it Merlot."),
...
("Claret",
"British term for red Bordeaux wines. See Bordeaux."),
...
("Moscato", "Also known as Muscat, Muscat Blanc and Muscat Canelli. With pronounced spice and floral notes it can also be used for blending. A versatile grape that can turn into anything from Asti Spumante and Muscat de Canelli to a dry wine like Muscat d’Alsace.")
...
("Pinot Grigio", "Also known as Pinot Gris. At its best this varietal produces wines that are soft, perfumed with more color than most other white wines. Grown mainly in northeast Italy, but as Pinot Gris it is grown in Alsace & known as Tokay."),
